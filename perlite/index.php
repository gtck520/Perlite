        ...
        <div class="workspace is-left-sidedock-open">
            <div class="workspace-ribbon side-dock-ribbon mod-left">
                ...
                <div class="side-dock-settings">
                    <div class="clickable-icon side-dock-ribbon-action" aria-label="Help" aria-label-position="right">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="svg-icon help">
                            <path
                        ...
                        <div class="workspace-tab-header-container-inner" style="--animation-dur:250ms;">
                            <div class="workspace-tab-header is-active" draggable="true" aria-label="Files"
                                ...
                                <div class="workspace-tab-header-inner">
                                    <div class="workspace-tab-header-inner-icon"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="workspace-tab-header" draggable="true" aria-label="Search" aria-label-delay="50"
                                data-type="search">
                                <div class="workspace-tab-header-inner">
                                    <div class="workspace-tab-header-inner-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            ...
                            <div class="workspace-leaf-content" data-type="file-explorer">
                                ...
                                <div class="nav-files-container node-insert-event" style="position: relative;">
                                    <div class="tree-item nav-folder mod-root">
                                        <div class="tree-item-self" data-path="/">

                                            <div class="workspace-sidedock-vault-profile">
                                                <div class="workspace-drawer-vault-switcher has-active-menu">

                                                    <div class="workspace-drawer-vault-name"> <?php echo $vaultName ?>
                                                    </div>
                                                ...
                                                <div class="clickable-icon nav-action-button" aria-label="Expand all">
                                    ...
                                    <div id="graph_content" style="display: none">
                                        ...
                                        <div class="graph-controls is-close">
                                            ...
                                            <div class="clickable-icon graph-controls-button mod-open"
                                                aria-label="Open graph settings"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            ...
                                            <div class="tree-item graph-control-section mod-display">
                                                ...
                                                <div class="tree-item-children">
                                                    <div class="setting-item mod-slider">
                                                        ...
                                                        <div class="setting-item-control"><input class="slider nodeSize"
                                                                type="range" min="5" max="40" step="2"></div>
                                                    ...
                                                    <div class="tree-item graph-control-section mod-display">
                                                        ...
                                                        <div class="tree-item-children">
                                                            <div class="setting-item mod-slider">
                                                                ...
                                                                <div class="setting-item-control"><input
                                                                        class="slider font-size" type="range" min="10"
                                                                        max="30" step="1"></div>
                                                            </div>
            ...
            <div class="markdown-preview-view markdown-rendered node-insert-event show-indentation-guide">
                <div class="markdown-preview-sizer markdown-preview-section"
                    ...
                    <div class="mod-header">
                        <div class="inline-title pophover-title" spellcheck="false" tabindex="-1" enterkeyhint="done">
                        </div>
